...
class TestLinkComponent(unittest.TestCase):
    def test_link_initialization(self):
        link = LinkComponent(href="https://example.com", text="Example", target="_blank")
    ...
    def test_link_render(self):
        ...
        expected_html = f'<a id="{link.id}" href="https://example.com" target="_self">Example</a>'
    ...
    def test_link_render_with_context(self):
        ...
        expected_html = (
            f'<a id="{link.id}" href="https://example.com" target="_self">Visit our site</a>'
        )
