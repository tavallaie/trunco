...
class TestDaisyUIButton(unittest.TestCase):
    def test_button_default(self):
        ...
        expected_html = (
            f'<button id="{button.id}" class="btn btn-primary btn-md">Click Me</button>'
        )
    ...
    def test_button_with_variant_and_size(self):
        ...
        expected_html = (
            f'<button id="{button.id}" class="btn btn-success btn-lg">Click Me</button>'
        )
        self.assertEqual(str(button), expected_html)
    ...
    def test_button_with_modifiers(self):
        ...
        expected_html = f'<button id="{button.id}" class="btn btn-warning btn-sm btn-outline glass">Click Me</button>'
        self.assertEqual(str(button), expected_html)
    ...
    def test_button_with_additional_classes(self):
        ...
        expected_html = f'<button id="{button.id}" class="btn btn-primary btn-md custom-class another-class">Click Me</button>'
        self.assertEqual(str(button), expected_html)
