...
def doc_page(
    ...
    *,
    ...
    theme_btn.add_child(
        ...
        '<svg class="doc-theme-icon doc-theme-icon--moon" '
        'xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" '
        'aria-hidden="true"><path d="M21.64,13a1,1,0,0,0-1.05-.14,'
        "8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2"
        'A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Z"/></svg>'
    )
    nav_end.add_child(theme_btn)

    github = Component(tag="a")
    github.add_class("doc-github-badge")
    github.add_attribute("href", "https://github.com/tavallaie/trunco")
